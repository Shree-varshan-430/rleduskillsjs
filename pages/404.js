...
export default function Custom404() {
    ...
    return (
        <>
            <Layout headerStyle={3} footerStyle={1} breadcrumbTitle="Error Page" headTitle="404 Error Page | RL Edu Skills" description="Sorry! The page you are looking for is not available. ">
