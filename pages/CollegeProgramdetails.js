...
export default function CounseDetails() {
    ...
    return (
        <>
            <Layout headerStyle={3} footerStyle={1} headTitle="Skill & Career Programs for Colleges | RL Edu Skills" description="Explore RL Edu Skills college programs designed to enhance students' skills and career readiness. Explore workshops, internships, and certifications. ">
                <section className="courses__breadcrumb-area">
                    <div className="container">
                        <div className="row">
                            <div className="col-lg-8">
                                <div className="courses__breadcrumb-content">
                                    <Link href="#" className="category">College</Link>
                                    <h1 className="title">Our College Training Program</h1>
                                    <p>Online & Offline | WOrkshops & Long Term program</p>
                            ...
                            <div className="col-xl-9 col-lg-8">
                                <div className="courses__details-wrapper">
                                    <div className="courses__details-inner">
                                        <h3 className="title">What is College Programs by RL Edu Skills</h3>

                                        <p><strong>RL Edu Skills College Programs</strong> are designed to bridge the gap between academic learning and industry readiness. Our programs aim to equip students with practical skills, professional exposure, and personal development opportunities, preparing them for <strong>careers and higher education.</strong></p>
                                        <p>We offer a range of programs tailored for colleges,<strong> including value-added courses, internship opportunities, placements preparation, workshops, CSR initiatives, and master trainer programs.</strong> Each program is designed to enhance students’ technical, soft, and professional skills while fostering a culture of learning, collaboration, and innovation.</p>
                                    </div>

                                    <div className="courses__details-inner">
                                        <h3 className="title">Program Offeringss</h3>

                                        <div className="event-details-list">
                                            <ul className="list-wrap">
                                                <li><i className="fas fa-check-circle" />Internships & Career Development Program</li>
                                                <li><i className="fas fa-check-circle" />Technical College Workshops</li>
                                                <li><i className="fas fa-check-circle" />Value Added Technical Education</li>
                                                <li><i className="fas fa-check-circle" />CSR Programs for College Students</li>
                                                <li><i className="fas fa-check-circle" />Placements Preparation Course</li>
                                                <li><i className="fas fa-check-circle" />Certifications</li>
                                    ...
                                    <div></div>
                                    <ul className="nav nav-tabs mt-40" id="myTab" role="tablist">
                                        <li className="nav-item" onClick={() => handleOnClick(1)}>
                                            <button className={activeIndex === 1 ? "nav-link active" : "nav-link"}>Key Program Offerings</button>
                                        </li>
                                    ...
                                    <div className="tab-content" id="myTabContent">
                                        <div className={activeIndex === 1 ? "tab-pane active" : "tab-pane"}>
                                            <div className="courses__details-content">
                                                <h5 className="title">Value-Added Programs</h5>
                                                <h6 className="sub-title mt-10"></h6>
                                                <div className="event-details-list">
                                                    <ul className="list-wrap">
                                                        <li><i className="fas fa-check-circle" />Industry-aligned short-term courses</li>
                                                        <li></li>
                                                        <li><i className="fas fa-check-circle" />Technical and soft skill modules </li>
                                                ...
                                                <h5 className="title">Placements Programs</h5>
                                                <h6 className="sub-title mt-10"></h6>
                                                <div className="event-details-list">
                                                    <ul className="list-wrap">
                                                        <li><i className="fas fa-check-circle" />Training in interview skills, resume building,</li>
                                                        <li></li>
                                                        <li><i className="fas fa-check-circle" />Training for professional communication</li>
                                                        <li></li>
                                                        <li><i className="fas fa-check-circle" />Mock assessments</li>
                                                        <li></li>
                                                        <li><i className="fas fa-check-circle" />Industry-preparation sessions</li>
                                                        <li></li>
                                                        <li><i className="fas fa-check-circle" />Guidance for campus recruitment</li>

                                                    </ul>
                                                </div>
                                                <h5 className="title">Internship Opportunities</h5>
                                                <h6 className="sub-title mt-10"></h6>
                                                <div className="event-details-list">
                                                    <ul className="list-wrap">
                                                        <li><i className="fas fa-check-circle" />Real-world exposure through internships</li>
                                                        <li></li>
                                                        <li><i className="fas fa-check-circle" />Experience in technical, managerial, and research projects</li>
                                                        <li></li>
                                                        <li><i className="fas fa-check-circle" />Mentorship to ensure learning outcomes</li>
                                                        <li></li>
                                                        <li><i className="fas fa-check-circle" />Industry-preparation</li>
                                                ...
                                                <div className="courses__details-inner">
                                                    ...
                                                    <div className="event-details-list">
                                                        <ul className="list-wrap">
                                                            <li><i className="fas fa-check-circle" />Holistic Student Development</li>
                                                            <li><i className="fas fa-check-circle" />Industry-Relevant Learning</li>
                                                            <li><i className="fas fa-check-circle" />Flexible Program Options</li>
                                                            <li><i className="fas fa-check-circle" />Career-Focused</li>
                                                            <li><i className="fas fa-check-circle" />Mentorship & Master Trainers</li>
                                            ...
                                            <div className="courses__details-inner">
                                                ...
                                                <p>Take the next step toward workplace excellence and personal growth. Join our Colleges Program today!</p>
                                        ...
                                        <div className="event-cost-wrap">
                                            ...
                                            <div className="event-information-wrap">
                                                ...
                                                <ul className="list-wrap">
                                                    ...
                                                    <li><i className="flaticon-flash" />Category <span>College Program</span></li>
