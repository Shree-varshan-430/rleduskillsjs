            ...
            <Slider {...settings} className="row courses-slider-active">
                <div className="col">
                    <div className="courses__item-two shine__animate-item">
                        ...
                        <div className="courses__item-two-content">
                            ...
                            <h5 className="title"><Link href="/course-details">Soft Skills training courses</Link></h5>
                ...
                <div className="col">
                    <div className="courses__item-two shine__animate-item">
                        ...
                        <div className="courses__item-two-content">
                            <Link href="#" className="courses__item-tag" style={{ backgroundColor: '#F7EEFA', color: '#BC18E4' }}>Technical</Link>
                            <h5 className="title"><Link href="/course-details">Python Programming Course</Link></h5>
                            <ul className="courses__item-meta list-wrap">
                ...
                <div className="col">
                    <div className="courses__item-two shine__animate-item">
                        ...
                        <div className="courses__item-two-content">
                            <Link href="#" className="courses__item-tag" style={{ backgroundColor: '#FFF0F9', color: '#FF109F' }}>Internship</Link>
                            <h5 className="title"><Link href="/course-details">Internship Computer Science</Link></h5>
                            <ul className="courses__item-meta list-wrap">
                ...
                <div className="col">
                    <div className="courses__item-two shine__animate-item">
                        ...
                        <div className="courses__item-two-content">
                            <Link href="#" className="courses__item-tag" style={{ backgroundColor: '#F5F0FF', color: '#560EF0' }}>English</Link>
                            <h5 className="title"><Link href="/course-details">Master Trainer Program (IELTS/ELT/Soft Skills)</Link></h5>
                            <ul className="courses__item-meta list-wrap">
