...
const PageHead = ({ headTitle }) => {
  const defaultTitle = "RL EDU SKILLS : Education & Skills Development";
  const defaultDescription =
    "RL EDU Skills provides Skills Development programs for Schools, Colleges, and Working Professionals to enhance their career prospects.";
