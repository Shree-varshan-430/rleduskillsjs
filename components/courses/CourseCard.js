        ...
        <>
            <div className="courses__item-two shine__animate-item">
                ...
                <div className="courses__item-two-content">
                    <Link href={`/course/${item.category}`} className="courses__item-tag" style={{ backgroundColor: '#E8F9EF', color: '#04BC53' }}>{item.category}</Link>
                    <h5 className="title"><Link href={`/course/${item.courseTitle}`}>{item.courseTitle}</Link></h5>
