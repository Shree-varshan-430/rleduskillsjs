                        ...
                        <div className="col-lg-6">
                            <div className="banner__content">
                                ...
                                <span className="sub-title" data-aos="fade-right" data-aos-delay={200}>100% Satisfaction
                                    Guarantee</span>
                                <h1 className="title tg-svg" data-aos="fade-right" data-aos-delay={400}>Master Advanced Technical and Language Prowess with <span className="position-relative"><span className="svg-icon" id="svg-2" data-svg-icon="assets/img/icons/title_shape.svg"/> RL Edu Skills</span></h1>
